        ...
        <div className="w-full lg:w-2/6 flex items-center justify-center lg:justify-start">
          ...
          >
            ...
            {frontImage ? (
              ...
              <label
                htmlFor="file"
                className={`text-xl p-4 h-[100%] w-[100%] hover:cursor-pointer ${
        ...
        <div className="w-full lg:w-4/6">
          <div className="flex flex-col">
            ...
            <input
              ...
              className="mt-4 px-4 py-2 outline-none border border-zinc-800 rounded dark:border-zinc-300"
              value={Inputs.title}
              onChange={onChangeInputs}
              style={{ color: "black" }} // text color for dark mode
            />
          </div>
          ...
          <div className="flex mt-4">
            ...
            <div className="flex flex-col w-4/6">
              ...
              <select
                name="category"
                id="category"
                className="border border-zinc-900 rounded mt-4 outline-none px-4 py-2 dark:border-zinc-300 text-black"
